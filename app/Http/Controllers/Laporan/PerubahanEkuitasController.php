...
class PerubahanEkuitasController extends Controller
{
    ...
    public function generate(Request $request)
    {
        ...
        // 1. Hitung Saldo Awal Ekuitas (semua akun ekuitas sebelum start_date)
        $saldoAwalEkuitas = (clone $baseQuery)
        ...
        $penguranganModal = (clone $baseQuery)
            ->whereBetween('jurnal_umums.tanggal_transaksi', [$startDate, $endDate])
