        ...
        <form action="{{ route('admin.manajemen-data.unit_usaha.update', $unitUsaha->unit_usaha_id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_unit" class="form-control @error('nama_unit') is-invalid @enderror" id="nama_unit" placeholder="Masukkan Nama Unit Usaha" value="{{ old('nama_unit', $unitUsaha->nama_unit) }}" required>
                    @error('nama_unit')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="jenis_usaha" class="form-control @error('jenis_usaha') is-invalid @enderror" id="jenis_usaha" placeholder="Contoh: Perdagangan, Pertanian, Jasa" value="{{ old('jenis_usaha', $unitUsaha->jenis_usaha) }}" required>
                    @error('jenis_usaha')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="bungdes_id" id="bungdes_id" class="form-control @error('bungdes_id') is-invalid @enderror" required>
                        ...
                        @foreach ($bungdeses as $bungdes)
                            <option value="{{ $bungdes->bungdes_id }}" {{ old('bungdes_id', $unitUsaha->bungdes_id) == $bungdes->bungdes_id ? 'selected' : '' }}>
                                {{ $bungdes->nama_bumdes }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tanggal_mulai_operasi" class="form-control @error('tanggal_mulai_operasi') is-invalid @enderror" id="tanggal_mulai_operasi" value="{{ old('tanggal_mulai_operasi', optional($unitUsaha->tanggal_mulai_operasi)->format('Y-m-d')) }}">
                ...
                <div class="form-group">
                    ...
                    <select name="status_operasi" id="status_operasi" class="form-control @error('status_operasi') is-invalid @enderror" required>
                        ...
                        <option value="Pasif" {{ old('status_operasi', $unitUsaha->status_operasi) == 'Pasif' ? 'selected' : '' }}>Pasif</option>
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary">Perbarui Unit Usaha</button>
            </div>
        </form>
    </div>
@stop
