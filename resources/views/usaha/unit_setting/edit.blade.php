                ...
                <form action="{{ route('usaha.unit_setting.update') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_mulai_operasi" value="{{ old('tanggal_mulai_operasi', $unitUsaha->tanggal_mulai_operasi) }}" class="form-control @error('tanggal_mulai_operasi') is-invalid @enderror" id="tanggal_mulai_operasi">
