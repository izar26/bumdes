...
{{-- Pastikan Anda memiliki file ini di resources/views/components/confirm-modal.blade.php --}}
...
<script>
    $(document).ready(function() {
        ...
        $('#confirmModal').on('show.bs.modal', function(event) {
            ...
            const confirmButtonText = button.data('button-text');
            const confirmButtonClass = button.data('button-class');
            ...
            confirmButton.removeClass().addClass('btn').addClass(confirmButtonClass).addClass('confirm-action-btn');

            // Set aksi saat tombol konfirmasi diklik
            modal.find('.confirm-action-btn').off('click').on('click', function() {
